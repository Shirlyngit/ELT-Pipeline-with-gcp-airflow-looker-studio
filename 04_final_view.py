"""
This Airflow DAG automates the end-to-end ELT workflow for medical records using Google Cloud.
It checks for a CSV file in Google Cloud Storage, loads it into a BigQuery staging table, creates country-specific tables,
and builds reporting views with selected columns and filters for analytics in Looker Studio.
"""
