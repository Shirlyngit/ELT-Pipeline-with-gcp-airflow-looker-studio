"""
Airflow DAG to load a CSV file containing medical records from Google Cloud Storage (GCS) into a BigQuery table.
This pipeline automates the ingestion process, infers schema, and prepares data for analytics in Looker Studio.
Designed for scalable ELT workflows using GCP services.
"""
