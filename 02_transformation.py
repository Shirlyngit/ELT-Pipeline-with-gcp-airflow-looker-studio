"""
This Airflow DAG loads a CSV file of medical records from Google Cloud Storage (GCS) into a BigQuery staging table,
then creates country-specific tables in a transformation dataset using SQL queries.
It automates file existence checks, ingestion, and data transformation for scalable ELT workflows in Google Cloud.
"""
